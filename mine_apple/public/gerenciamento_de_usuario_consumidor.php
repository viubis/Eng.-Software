...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="styles/gerenciamento_usuario.css">
                            ...
                            <div class="form-group col-md-9">
                                <div class="col-sm-10" style="margin-bottom: 10px">
                                    <input type="text" readonly class="form-control-plaintext" id="staticNome"
                                           placeholder="Nome do consumidor" disabled>
                                </div>
                                <div class="col-sm-10">
                                    <input type="number" readonly class="form-control-plaintext" id="staticCpf"
                                           placeholder="CPF do consumidor" disabled>
                                </div>
                            </div>
