            ...
            <div class="row">
                <div class="row col-md-6">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <ul class="image_list">
                                <li data-image="images/single_4.jpg"><img src="images/abacaxi_puro.jpg" alt=""></li>
                                <li data-image="images/single_2.jpg"><img src="images/abacaxi_perola.jpg" alt=""></li>
                                <li data-image="images/single_3.jpg"><img src="images/abacaxi2.jpg" alt=""></li>
                            </ul>
                        </div>

                        <!-- Selected Image -->
                        <div class="col-md-8">
                            <div class="image_selected"><img src="images/abacaxi.png" alt=""></div>
                        </div>
                    </div>
                    <div class="frete">
                        <div class="row">
