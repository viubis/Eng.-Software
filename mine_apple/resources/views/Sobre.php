                ...
                <div class="col-lg-12 ">
                    <div class="contact_form_title">RC Business Enterprises</div>
                        ...
                        <div>
                            ...
                            <p class="text-justify">Com isso, o Mineapple foi criada, como ferramenta para bater os objetivos citados anteriormente.  Na plataforma você poderá ter aceso a centenas de produtos da região, e criar sua assinatura, para receber na sua casa na frequência que desejar, além de ter opções de debito automático para não precisar se preocupar mais com pagamentos.</p>
                            <p class="text-justify">Para mais informações, sobre RC Business Enterpreses ou sobre MIneApple, acesse o ste da empresa, ou entre na aba “fale conosco”.</p>
