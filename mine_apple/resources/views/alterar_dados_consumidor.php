...
<head>
    ...
    <title>Alterar dados de consumidor</title>
                        ...
                        <fieldset>
                            ...
                            <div class="form-bottom">
                                <div class="form-group">
                                    ...
                                    <input disabled type="text" name="form-first-name" placeholder="Nome..."
                                           class="form-first-name form-control" id="form-first-name">
                                </div>
                                <div class="form-group">
                                    <label class="sr-only" for="form-first-name">Last name</label>
                                    <input disabled type="text" name="form-last-name" placeholder="Sobrenome..."
                                           class="form-first-name form-control" id="form-last-name1">
                                </div>
                                <div class="form-group">
                                    <label class="sr-only" for="form-last-name">Last name</label>
                                    <input disabled type="text" name="form-last-name" placeholder="CPF..."
                                           class="form-last-name form-control" id="form-last-name">
                                </div>
                                <div class="form-group">
                                    <label class="sr-only" for="form-first-name">First name</label>
                                    <input disabled type="email" name="form-email" placeholder="Email..."
                                           class="form-first-name form-control" required id="form-first-name2">
                                </div>
                                <div class="form-group">
                                    <label class="sr-only" for="senha">Senha</label>
                                    <input disabled type="password" minlength="8" name="form-senha" placeholder="Senha..."
                                           class="form-first-name form-control" required id="senha">
                                </div>
                                <div class="form-group">
                                    <label class="sr-only" for="confSenha">Confirmação de senha</label>
                                    <input disabled type="password" minlength="8" name="form-confirmacao-senha"
                                ...
                                <div class="form-group">
                                    ...
                                    <select disabled class="form-control" id="sexo" required>
                        ...
                        <fieldset>
                            ...
                            <div class="form-bottom">
                                ...
                                <div class="form-group">
                                    ...
                                    <input disabled type="text" name="form-facebook" placeholder="Nome do Titular do cartão"
                                           class="form-facebook form-control" id="idnome">
                                </div>
                                <div class="form-group">
                                    <label class="sr-only" for="form-first-name">Número do cartão</label>
                                    <input disabled type="text" name="form-facebook" placeholder="Número do cartão"
                                           class="form-facebook form-control" id="idBanco">
                                </div>
                                <div class="form-group">
                                    <label class="sr-only" for="form-first-name">Validade</label>
                                    <input disabled type="text" name="form-facebook" placeholder="Validade"
