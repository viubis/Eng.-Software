        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 offset-lg-3 form-box">
                    <form role="form" action="{{ route('password.request') }}" method="post" data-toggle="validator" class="registration-form">
                        ...
                        <fieldset>
                            ...
                            <div class="form-bottom">
                                <div class="form-group">
                                    ...
                                    <input  id="email" type="email" name="email" placeholder="Email..." class="form-first-name form-control" value="{{ $email ?? old('email') }}" required autofocus>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="password_confirmation" placeholder="Confirmação da senha..."
